...
namespace StarworkGC.Localization
{
    ...
    public class CustomSettings
    {
        ...
        static public T Get<T>(string name, T defaultValue) where T : Object
        {
            ...
            T retVal = CustomEditorTools.LoadAsset<T>(path);
        ...
        {
            get { return GetBool("StarworkGC Transform Handles", false); }
            set { SetBool("StarworkGC Transform Handles", value); }
        }

        static public bool minimalisticLook
        {
            get { return GetBool("StarworkGC Minimalistic", false); }
            set { SetBool("StarworkGC Minimalistic", value); }
        }

        static public bool unifiedTransform
        {
            get { return GetBool("StarworkGC Unified", false); }
            set { SetBool("StarworkGC Unified", value); }
        }

        static public Color color
        {
            get { return GetColor("StarworkGC Color", Color.white); }
            set { SetColor("StarworkGC Color", value); }
        }

        static public Color foregroundColor
        {
            get { return GetColor("StarworkGC FG Color", Color.white); }
            set { SetColor("StarworkGC FG Color", value); }
        }

        static public Color backgroundColor
        {
            get { return GetColor("StarworkGC BG Color", Color.black); }
            set { SetColor("StarworkGC BG Color", value); }
        }

        static public ColorMode colorMode
        {
            get { return GetEnum("StarworkGC Color Mode", ColorMode.Blue); }
            set { SetEnum("StarworkGC Color Mode", value); }
        }

        static public bool trueColorAtlas
        {
            get { return GetBool("StarworkGC Truecolor", true); }
            set { SetBool("StarworkGC Truecolor", value); }
        }
        #endregion
    }
}