...
{
    ///<summary>
    /// Custom inspector for LocalizeText
    ///</summary>
    ...
    public class LocalizeTextEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            SerializedProperty sp = CustomEditorTools.DrawProperty("Key", serializedObject, "key");
            ...
            if (isPresent)
            {
                if (CustomEditorTools.DrawHeader("Preview"))
                {
                    ...
                    if (Localization.dictionary.TryGetValue(myKey, out values))
                    {
                        ...
                        else
                        {
                            for (int i = 0; i < keys.Length; ++i)
                            {
                                ...
                                if (GUILayout.Button(values[i], CustomEditorTools.textArea, GUILayout.MinWidth(80f), GUILayout.MaxWidth(Screen.width - 110f)))
                                {
